...
class RemoveCardFromCollectionHandlerTest {
    ...
    fun should_do_nothing_for_non_existing_card() {
        ...
        val events = handler.handle(RemoveCardFromCollection(CardFixtures.plus2Mace.id, false))
    ...
    fun should_decrease_nb_owned_when_card_was_in_multiple() {
        ...
        Assertions.assertThat(events)
            ...
            .containsOnly(CardDisowned(CardFixtures.plus2Mace.id))
        verify {
            cardProjection.update(
                CardFixtures.plus2Mace.id,
    ...
    fun should_reset_owned_state_to_false_for_last_card() {
        ...
        val events = handler.handle(RemoveCardFromCollection(CardFixtures.plus2Mace.id, true))
    ...
    fun should_listen_to_RemoveCardFromCollection_command() {
        ...
        Assertions.assertThat(listenTo).isEqualTo(RemoveCardFromCollection::class)
    }
}